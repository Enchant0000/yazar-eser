...
export default function App() {
  ...
  const tumKartlar = Object.values(data).flatMap(d => d.kartlar || []);
  
  let kartlar = donemBilgi.kartlar || [];
      ...
      <div style={{ borderBottom: "1px solid #1e293b", padding: "16px 24px" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            ...
            {donemBilgi.turler && donemBilgi.turler.map(tur => {
      ...
      {!quizModu && (
        <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "24px" }}>
          {!shuffled ? (
            ...
            <div>
              {donemBilgi.yazarlar && donemBilgi.yazarlar.map((yazar, yi) => {
