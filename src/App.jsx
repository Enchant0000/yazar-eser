...
function SonucEkrani({ toplam, bildiSayisi, bilmediSayisi, bilmediList, onExit, modLabel }) {
  ...
  return (
    <div style={{
      ...
      color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", zIndex: 9999,
    }}>
      <div style={{ maxWidth: "480px", width: "100%", textAlign: "center" }}>
        ...
        <button onClick={() => onExit("cikis")}
          style={{ padding: "10px 20px", background: "transparent", border: "1px solid #334155", borderRadius: "6px", color: "#94a3b8", fontWeight: "700", cursor: "pointer", width: "100%", fontFamily: "monospace", fontSize: "12px" }}>
          Geri Dön
        </button>
      </div>
    </div>
    ...
    <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, minHeight: "100vh", background: "linear-gradient(to bottom, #020617, #0f172a)", color: "#fff", display: "flex", flexDirection: "column", zIndex: 9999 }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px" }}>
        <div style={{ width: "100%", maxWidth: "520px" }}>
          ...
          {secilen !== null && (
            <button onClick={handleSonraki} style={{ marginTop: "20px", padding: "12px 24px", background: "#c8922a", border: "none", borderRadius: "6px", color: "#000", fontWeight: "700", cursor: "pointer", width: "100%", fontFamily: "monospace", fontSize: "12px" }}>
...
export default function App() {
  ...
  const tumKartlar = useMemo(() => {
    const kartlar = [];
    Object.keys(data).forEach(donem => {
      data[donem].yazarlar.forEach(yazar => {
        yazar.eserler.forEach(eser => {
  ...
  return (
    <div style={{ background: "#020617", color: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ borderBottom: "1px solid #1e293b", padding: "16px 24px" }}>
        <div style={{ maxWidth: "1152px", margin: "0 auto", display: "flex", gap: "8px", flexWrap: "wrap" }}>
          ...
          <button onClick={() => handleStartQuiz(kartlar, "sikli")}
            ...
            <IconZap /> Tümü Klasik ({kartlar.length})
          </button>
          ...
          <button onClick={() => handleStartQuiz(shuffle(kartlar), "sikli")}
            ...
            <IconList /> Tümü Şıklı ({kartlar.length})
          </button>
        </div>
      </div>
      ...
      {!quizModu && (
        <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "24px", display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "16px" }}>
